...
public abstract class ServerEmoteAPI {
     ...
     */
    public static void setPlayerPlayingEmote(UUID player, @Nullable KeyframeAnimation emote, float speed, boolean mirrored) {
        INSTANCE.setPlayerPlayingEmoteImpl(player, emote, false, speed, mirrored);
    }
     ...
     * @param emote the new emote
     */
    public static void forcePlayEmote(UUID player, @Nullable KeyframeAnimation emote, float speed, boolean mirrored) {
        INSTANCE.setPlayerPlayingEmoteImpl(player, emote, true, speed, mirrored);
    }
     ...
     */
    public static void playEmote(UUID player, @Nullable KeyframeAnimation emote, boolean forced, float speed, boolean mirrored) {
        INSTANCE.setPlayerPlayingEmoteImpl(player, emote, forced, speed, mirrored);
    }
    ...
    protected abstract void setPlayerPlayingEmoteImpl(UUID player, @Nullable KeyframeAnimation KeyframeAnimation, boolean isForced, float speed, boolean isMirrored);
