...
public abstract class EmotePlayer<T> extends KeyframeAnimationPlayer implements IEmotePlayer {
    ...
    public EmotePlayer(KeyframeAnimation emote, Consumer<Layer.Note> noteConsumer, int t) {
        super(emote, t);
        super.setFirstPersonMode(FirstPersonMode.THIRD_PERSON_MODEL);
        super.getFirstPersonConfiguration(tickDelta).setShowRightArm(true);
        super.getFirstPersonConfiguration(tickDelta).setShowLeftArm(true);
        super.getFirstPersonConfiguration(tickDelta).setShowRightItem(true);
        super.getFirstPersonConfiguration(tickDelta).setShowLeftItem(true);
